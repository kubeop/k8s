...
images = {
    ...
    "ghcr.io/flannel-io/flannel": data['flannel']['version'],
    "ghcr.io/flannel-io/flannel-cni-plugin": data['flannel']['plugin_version'],
    ...
    "registry.aliyuncs.com/google_containers/pause": data['containerd']['cri']['sandbox_image']['tag'],
